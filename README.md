...
- Excel formulas, pivot tables, and dashboard creation  
- Power BI data modeling and visualization  
- SQL table creation, joins, views, and indexing  
- Basic Python scripting and logic  
- Clear documentation and communication of analytical work  
